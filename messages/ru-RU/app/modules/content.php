...
return [
    ...
    'View language version: {language}' => "Смотреть языковую версию: {language}",
    'Delete language version: {language}' => "Удалить языковую версию: {language}",
    'Are you sure you want to delete this block?' => "Вы действительно желаете удалить этот блок?",
    'Are you sure you want to delete this list?' => "Вы действительно желаете удалить этот список?",
    'Are you sure you want to delete this field?' => "Вы действительно желаете удалить это поле?",
    'Are you sure you want to delete the language version of this block?' => "Вы действительно желаете удалить языковую версию блока?",
    'Are you sure you want to delete the language version of this list?' => "Вы действительно желаете удалить языковую версию списка?",
