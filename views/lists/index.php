...
<div class="content-lists-index">
            ...
            [
                ...
                'buttons'=> [
                    'view' => function($url, $data, $key) {
                                ...
                                if ($item_locale === $locale['locale']) { // Fixing default locale from PECL intl
                                    ...
                                    if ($data->locale === $locale['locale']) // It`s source version
                                        ...
                                        $output[] = Html::a(Yii::t('app/modules/content','Preview of language version: {language}', [
                                            'language' => $locale['name']
                                        ]), ['lists/view', 'id' => $data->id, 'locale' => $locale['locale']], [
                                            'title' => Yii::t('app/modules/content', 'Content preview'),
                                            'data-toggle' => 'modal',
                                            'data-target' => '#contentPreviewModal',
                                            'data-id' => $data->id,
                            ...
                            foreach ($locales as $locale) {
                                if (!empty($locale)) {
                                    ...
                                    if ($data->locale === $locale) // It`s source version
                                        ...
                                        $output[] = Html::a(Yii::t('app/modules/content','Preview of version: {language}', [
                                            'language' => $language
                                        ]), ['lists/view', 'id' => $data->id, 'locale' => $locale], [
                                            'title' => Yii::t('app/modules/content', 'Content preview'),
                                            'data-toggle' => 'modal',
                                            'data-target' => '#contentPreviewModal',
                                            'data-id' => $data->id,
                        ...
                        if (is_array($output) && $data->getContentCount() && $data->getFieldsCount()) {
                            if (count($output) > 1) {
                                $html = '';
                                ...
                                if ($item_locale === $locale['locale']) { // Fixing default locale from PECL intl
                                    ...
                                    if ($data->locale === $locale['locale']) // It`s source version
                                        ...
                                        $output[] = Html::a(Yii::t('app/modules/content','Edit language version: {language}', [
                                            'language' => $locale['name']
                                        ]), ['lists/update', 'id' => $data->id, 'locale' => $locale['locale']]);
                            ...
                            foreach ($locales as $locale) {
                                if (!empty($locale)) {
                                    ...
                                    if ($data->locale === $locale) // It`s source version
                                        ...
                                        $output[] = Html::a(Yii::t('app/modules/content','Edit language version: {language}', [
                                            'language' => $language
                                        ]), ['lists/update', 'id' => $data->id, 'locale' => $locale]);
                                ...
                                if ($item_locale === $locale['locale']) { // Fixing default locale from PECL intl
                                    ...
                                    if ($data->locale === $locale['locale']) // It`s source version
                                        ...
                                        $output[] = Html::a(Yii::t('app/modules/content','Delete language version: {language}', [
                                            'language' => $locale['name']
                                        ]), ['lists/delete', 'id' => $data->id, 'locale' => $locale['locale']], [
                                            'data-method' => 'POST',
                            ...
                            foreach ($locales as $locale) {
                                if (!empty($locale)) {
                                    ...
                                    if ($data->locale === $locale) // It`s source version
                                        ...
                                        $output[] = Html::a(Yii::t('app/modules/content','Delete language version: {language}', [
                                            'language' => $language
                                        ]), ['lists/delete', 'id' => $data->id, 'locale' => $locale], [
                                            'data-method' => 'POST',
                                            'data-confirm' => Yii::t('app/modules/content', 'Are you sure you want to delete the language version of this list?')
                                        ]);
    ...
    <hr/>
    <div>
        <?= Html::a(Yii::t('app/modules/content', 'Add new list'), ['lists/create'], ['class' => 'btn btn-add btn-success pull-right']) ?>
    </div>
    <?php Pjax::end(); ?>
</div>
